...
public class FileCompressionTool {
    ...
    public static void main(String[] args) {
        ...
        ImageIcon leftImageIcon = new ImageIcon(new ImageIcon("C:/Users/ABDUL RAFAY/Desktop/SSUET_Logo.png").getImage()
                .getScaledInstance(100, 100, Image.SCALE_SMOOTH));
        ImageIcon rightImageIcon = new ImageIcon(new ImageIcon("C:/Users/ABDUL RAFAY/Desktop/SED.png").getImage()
                .getScaledInstance(100, 100, Image.SCALE_SMOOTH));
        ...
        JMenuItem lzwOption = new JMenuItem("LZW");
        textMenu.add(huffmanOption);
        textMenu.add(gzipOption);
        textMenu.add(lzwOption);
        ...
        lzwOption.setToolTipText("LZW Compression: Efficient for repetitive data patterns.");
        ...
        lzwOption.addActionListener(e -> {
            selectedAlgorithm = "LZW";
            JOptionPane.showMessageDialog(frame, "LZW Compression Selected!");
        });
        ...
        compressButton.addActionListener(e -> {
            ...
            boolean isImageFile = fileExtension.equals("jpeg") || fileExtension.equals("jpg")
            ...
            if (isTextFile && (selectedAlgorithm.equals("JPEG") || selectedAlgorithm.equals("GIF"))) {
                JOptionPane.showMessageDialog(frame,
                        "You selected an image compression algorithm for a text file.\n" +
                                "Please select an appropriate algorithm (e.g., Huffman, Gzip, or LZW).",
            ...
            try {
                ...
                } else if ("LZW".equals(selectedAlgorithm)) {
                    compressWithLZW(inputFilePath, outputFilePath + "/compressed.lzw");
                    JOptionPane.showMessageDialog(frame, "LZW Compression Completed!");
    ...
    private static void compressWithLZW(String inputFilePath, String outputFilePath) throws IOException {
        int dictSize = 256;
